...
export const SEARCHABLE_TECH_STACKS = [
  "Java", "Spring Boot", "React", "Next.js", "Node", 
  "Python", "Flutter", "Android", "AI", "Machine Learning", 
  "Blockchain", "Cloud", "DevOps", "Rust", "Go", 
  "C++", "Web3", "Open Source", "Security"
];
